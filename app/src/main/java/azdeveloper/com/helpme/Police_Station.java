...
public class Police_Station extends FragmentActivity implements OnMapReadyCallback,
...
GoogleApiClient.OnConnectionFailedListener,
    ...
    TextToSpeech t1,t2;
    private TextView showTextMsghere;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showTextMsghere= findViewById(R.id.showVoicTxtHerep);
    ...
    public void micOpening() {
        ...
        intent.putExtra("YES",
                String.valueOf(new DialogInterface.OnClickListener() {
        ...
        t1 = new TextToSpeech(Police_Station.this, new TextToSpeech.OnInitListener() {
            @Override
...
//    }
    ...
    public void nearByPlacesHotel()
    {
        ...
        Toast.makeText(getApplicationContext(), "Showing Nearby Police Station", Toast.LENGTH_SHORT).show();
///////////////////////////
